          ...
          {rows.map((row, i) => {
            ...
            return (
              <motion.div key={row.id}
                ...
                className="rounded-xl p-3 border border-brand-100 dark:border-brand-900/30 bg-brand-50/30 dark:bg-brand-900/10">
                ...
                {/* Edit form in mobile */}
                {editId === row.id && (
                  <div className="mt-3 pt-3 border-t border-brand-100 dark:border-brand-900/30 space-y-2">
        ...
        <AnimatePresence>
          {adding && (
            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}
              ...
              <div className="rounded-xl p-3 border border-brand-200 dark:border-brand-800/50 space-y-2"
            ...
            <AnimatePresence>
              {adding && (
                <motion.tr initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                  className="border-b border-brand-100 dark:border-brand-900/30 bg-brand-50/30 dark:bg-brand-900/20">
