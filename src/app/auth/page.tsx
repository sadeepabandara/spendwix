...
const AppleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 814 1000" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
    <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 326.7 0 150 0 176.7c0-43.3 0-162.8 124.9-262.9C180.4 67.4 247.8 40.5 318 40.5c59.4 0 114.7 20.2 148.7 37.4 34 17.3 82.7 17.3 116.7 0C607.2 65.4 656.3 40.5 724.3 40.5c75.4 0 145.2 30.5 199.1 79.3z"/>
  </svg>
)
